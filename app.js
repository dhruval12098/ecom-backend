...
app.use('/api/special-categories', require('./api/routes/special-categories/route'));
app.use('/api/special-subcategories', require('./api/routes/special-subcategories/route'));
app.use('/api/special-products', require('./api/routes/special-products/route'));
app.use('/api/special-category-labels', require('./api/routes/special-category-labels/route'));
